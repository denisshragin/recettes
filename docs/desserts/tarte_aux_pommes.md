...
* Incorporez le beurre et écrasez-le en feuillets dans la farine (du bout des doigts, avec un coupe-pâte ou avec deux couteaux froids). Il est important de voir de petits morceaux de beurre dans le mélange.
...
* Divisez la pâte en 2 disques et emballez ces derniers individuellement dans une pellicule plastique.
Réfrigérez-les au minimum une heure avant de les abaisser dans les moules à tarte (voir NOTE).
...
### INGRÉDIENTS
```
5 pommes Cortland ou Braeburn pelées, épépinées, coupées enquartier
...
* À l'aide d'un pinceau, badigeonner avec l'oeuf battu le pourtour de la première abaisse.
...
* Badigeonner avec l'oeuf battu toute la surface de la tarte. Saupoudrer de sucre.
